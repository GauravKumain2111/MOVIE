...
async function recommended() {
    try {
        ...
        console.error('Error in recommended function:', error);
        // Display error message on screen
        alert('Network error detected. Please check your internet connection.');
    }
}
...
async function newrelease() {
    try {
        ...
        console.error('Error in newrelease function:', error);
        // Display error message on screen
        alert('Network error detected. Please check your internet connection.');
    }
}
...
function details(moviedata) {
    ...
    async function topRated() {
        try {
            ...
            console.error('Error in topRated function:', error);
            alert('Network error detected. Please check your internet connection.');
...
async function series() {
    try {
        ...
        console.error('Error in series function:', error);
        // Display error message on screen
        alert('Network error detected. Please check your internet connection.');
    }
}
...
// function openNewPage(movieData) {
...
async function openNewPage(movieData) {
    try {
        ...
        console.error('Error in openNewPage function:', error);
